...
const items = [
   linkedChartRoll(GemstoneGrade1.name),
    [new ChartData("", "2d6*10", "cp"), new ChartData("", "4d8", "sp"), new ChartData("", "1d4", "gp"), linkedChartRoll(GemstoneGrade1.name)],
    [new ChartData("", "5d10", "sp"), new ChartData("", "1d4", "gp"), linkedChartRoll(GemstoneGrade1.name, 2)],
